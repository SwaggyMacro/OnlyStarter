...
flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('swaggymacro-admin-topic_starter', function (app) {
  app.extensionData["for"]('swaggymacro-only-starter').registerSetting({
